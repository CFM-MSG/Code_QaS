...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        # * Transformer
        parser.add_argument('--dec_layers1', default=3, type=int,
                            help="Number of encoding layers in the transformer")
        parser.add_argument('--dec_layers2', default=3, type=int,
                            help="Number of decoding layers in the transformer")
        parser.add_argument('--g_layers', default=3, type=int,
                            help="Number of layers in the gaussian transformer")
        ...
        parser.add_argument("--use_negative", default=True, type=bool)
        parser.add_argument("--neg_type", type=str, choices=['lnb', 'rev'])
        parser.add_argument('--nheads', default=8, type=int,
                            help="Number of attention heads inside the transformer's attentions")
        parser.add_argument('--num_props', default=8, type=int,
                            help="Number of gaussian proposals")
        parser.add_argument('--num_concepts', default=1, type=int,
                            help="Number of gaussian proposals")
        parser.add_argument('--num_neg_props', default=8, type=int,
                            help="Number of negative gaussian proposals")
        parser.add_argument('--num_pos_opt', default=3, type=int,
                            help="Number of positive proposals to optimize")
        parser.add_argument('--num_neg_opt', default=2, type=int,
                            help="Number of negative proposals to optimize")
        parser.add_argument('--ksi', default=0.15, type=float)
        parser.add_argument('--sigma', default=5, type=float,
                            help="Gauss weight sigma")
        ...
        parser.add_argument("--margin_2", type=float, default=0.1)
        parser.add_argument("--margin_3", type=float, default=0.1)
        parser.add_argument("--margin_4", type=float, default=0.1)
        parser.add_argument("--alpha_1", type=float, default=0.1)
        parser.add_argument("--alpha_2", type=float, default=0.1)
        parser.add_argument("--saliency_margin", type=float, default=0.1)
        parser.add_argument("--delta", type=float, default=0.2)
        parser.add_argument("--epsilon", type=float, default=1.0)
        parser.add_argument("--cvc_scaler_1", type=float, default=0.1)
        parser.add_argument("--cvc_scaler_2", type=float, default=0.1)
        parser.add_argument("--cvc_scaler_3", type=float, default=0.1)

        # * Loss coefficients
        parser.add_argument('--pos_rec_coef', default=0, type=float)
        parser.add_argument('--neg_rec_coef', default=0, type=float)
        parser.add_argument('--ref_rec_coef', default=0, type=float)
        parser.add_argument('--rank_loss_coef', default=0, type=float)
        parser.add_argument('--div_loss_coef', default=0, type=float)
        parser.add_argument('--sal_trip_coef', default=0, type=float)
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['qas/model.py', 'qas/transformer.py']
...
class TestOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--eval_results_dir", type=str, default='results',
